...
class PhrasalVerbExerciseService:

    def __init__(
        self,
        exercise_repo: PhrasalVerbExerciseRepositoryInterface,
    ...
    async def generate_exercise(
        ...
        prompt = await self.llm.generate_phrasal_verb_exercise(
    ...
    async def evaluate_answer(
        ...
        phrasal_verb_text = f"{pv.verb} {pv.particle}"
        evaluation = await self.llm.evaluate_phrasal_verb_answer(
            phrasal_verb=phrasal_verb_text,
            target_language=target_language_code,
